// FIC: Main operational dashboard — AppShell 3-zone layout with ActivityBar and LeftPanel.
// FIC: Dashboard operativo principal — layout AppShell de 3 zonas con ActivityBar y LeftPanel.
